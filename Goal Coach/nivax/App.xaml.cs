...
using HealthAndFitness.SettingsFlyouts;
    ...
    sealed partial class App : Application
    {
        ...
        protected async override void OnSearchActivated(Windows.ApplicationModel.Activation.SearchActivatedEventArgs args)
        {
            ...
            if (frame == null)
            {
                ...
                frame = new Frame();
                HealthAndFitness.Common.SuspensionManager.RegisterFrame(frame, "AppFrame");
                ...
                if (args.PreviousExecutionState == ApplicationExecutionState.Terminated)
                {
                    ...
                    try
                    {
                        await HealthAndFitness.Common.SuspensionManager.RestoreAsync();
                    }
                    catch (HealthAndFitness.Common.SuspensionManagerException)
                    {
